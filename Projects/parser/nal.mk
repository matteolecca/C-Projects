...
basic: $(BASE).c $(BASE).h mvm.c mvm.h
	$(CC) $(BASETEST).c mvm.c $(CFLAGS) -o $@ -DBASETEST
...
testparse : parse_s parse_d
	...
	./parse_s test5.$(BASE)
	./parse_s test6.$(BASE)
	./parse_s stat_ign.$(BASE)
	# ./parse_s varr_dec_err.$(BASE)
	
	#Valgrind needed from this point 
	...
	valgrind ./parse_d stat_ign.$(BASE)
	valgrind ./parse_d varr_dec_err.$(BASE)
...
testinterp : interp_s interp_d
	...
	valgrind ./interp_d stat_ign.$(BASE)
